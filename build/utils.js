...
function childrenEqual(a, b) {
  return _react2.default.Children.map(a, function (c) {
    return c.key;
  }), +(0, _lodash2.default)(_react2.default.Children.map(b, function (c) {
    return c.key;
  }) + _react2.default.Children.map(a, function (c) {
    return c.key;
  }), _react2.default.Children.map(b, function (c) {
    return c.key;
  })) && (0, _lodash2.default)(_react2.default.Children.map(a, function (c) {
