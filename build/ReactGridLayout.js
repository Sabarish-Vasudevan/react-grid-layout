...
var ReactGridLayout = (function(_React$Component) {
  ...
  ReactGridLayout.prototype.onDragStop = function onDragStop(i, x, y, _ref3) {
    ...
    // Set state
    var newLayout = this.considerOverlapForLayout(
      layout,
      this.compactType(),
      cols
    ); //compact(layout, this.compactType(), cols);
  ...
  ReactGridLayout.prototype.placeholder = function placeholder() {
    ...
    var _props3 = this.props,
      ...
      resizableProps = _props3.resizableProps;
  ...
  ReactGridLayout.prototype.considerOverlapForLayout = function considerOverlapForLayout(
    layout,
    compactType,
    cols
  ) {
    return this.props.allowOverlap
      ? layout
      : (0, _utils.compact)(layout, compactType, cols);
  };
  ...
  ReactGridLayout.prototype.processGridItem = function processGridItem(child) {
    ...
    var _props4 = this.props,
      ...
      resizableProps = _props4.resizableProps,
...
ReactGridLayout.propTypes = {
  ...
  resizableProps: _propTypes2.default.object,
