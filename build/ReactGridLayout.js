...
var ReactGridLayout = function (_React$Component) {
  ...
  function ReactGridLayout(props, context) {
    ...
    (0, _utils.autoBindHandlers)(_this, ["onDragStart", "onDrag", "onDragStop", "onResizeStart", "onResize", "onResizeStop", "considerOverlapForLayout"]);
    return _this;
  }
  ...
  ReactGridLayout.prototype.onDrag = function onDrag(i, x, y, _ref2) {
    ...
    layout = (0, _utils.moveElement)(layout, l, x, y, isUserAction, this.props.preventCollision, this.compactType(), cols, this.props.allowOverlap);

    this.props.onDrag(layout, oldDragItem, l, placeholder, e, node);

    this.setState({
      layout: this.considerOverlapForLayout(layout, this.compactType(), cols), //compact(layout, this.compactType(), cols),
  ...
  ReactGridLayout.prototype.onDragStop = function onDragStop(i, x, y, _ref3) {
    ...
    var isUserAction = true;
    layout = (0, _utils.moveElement)(layout, l, x, y, isUserAction, preventCollision, this.compactType(), cols, this.props.allowOverlap);

    this.props.onDragStop(layout, oldDragItem, l, null, e, node);

    // Set state
    var newLayout = this.considerOverlapForLayout(layout, this.compactType(), cols); //compact(layout, this.compactType(), cols);
  ...
  ReactGridLayout.prototype.considerOverlapForLayout = function considerOverlapForLayout(layout, compactType, cols) {
    return this.props.allowOverlap ? layout : (0, _utils.compact)(layout, compactType, cols);
  };
...
ReactGridLayout.propTypes = {
  ...
  allowOverlap: _propTypes2.default.bool,
